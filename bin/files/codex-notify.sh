...
# Keep the relays' locked-Computer-Use trust fresh whenever the app is in use.
...
"/Users/diegoalvarez/code/codex-relay-matrix/tools/relay-trusted/relay-trusted-ensure.sh" -t notify >/dev/null 2>&1 || true
