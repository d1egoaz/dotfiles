...
;;brew install emacs-mac --HEAD --with-modern-icon --with-modules

;;Currently using emacs from: https://github.com/daviderestivo/homebrew-emacs-head
```
brew tap daviderestivo/emacs-head
brew install emacs-head@28 --with-jansson --with-no-frame-refocus --with-imagemagick
```
