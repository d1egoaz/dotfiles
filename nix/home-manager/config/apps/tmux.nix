...

{
  programs.tmux = {
    ...
    mouse = false;
    escapeTime = 0;
    historyLimit = 2621440;

    # Extra configuration that's harder to express in nix options
    extraConfig = ''
      # ============================================= #
      ...
      # List of plugins
      # NOTE: These plugins are now managed by Nix (see plugins section below)
      # instead of TPM, but keeping the original configuration for reference:
