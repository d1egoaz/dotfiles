...
# Test routing audit counts and scheduled summaries with synthetic metadata only.
[private]
codex-model-usage-test:
    PYTHONDONTWRITEBYTECODE=1 python3 tests/test_codex_model_usage.py
